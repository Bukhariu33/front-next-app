...
const CorporateInvestorSignupSchema = Yup.object().shape({
  fullName: Yup.string()
    .trim()
...
export type CorporateInvestorSignupSchemaType = Yup.InferType<
  typeof CorporateInvestorSignupSchema
>;

export { CorporateInvestorSignupSchema };
